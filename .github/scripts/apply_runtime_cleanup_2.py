...
text = text.replace("android-runtime-polish.js?v=3", "android-runtime-polish.js?v=4")
text = text.replace("android-runtime-v2.js?v=3", "android-runtime-v2.js?v=4")
text = text.replace("android-deal-2026.js?v=20260714-3", "android-deal-2026.js?v=20260715-1")
if "--exclude 'rules/deal-animation-adapter.js'" not in text:
    text = text.replace(
        "            --exclude '*.log'",
        "            --exclude '*.log' \\\n            --exclude 'rules/deal-animation-adapter.js'",
    )

guard = """          ! grep -q 'playCardDealAnimation =' www/ace-deal-animation.js
...
old_guard = """          ! grep -q 'playCardDealAnimation =' www/ace-deal-animation.js
          ! grep -q 'playCardDealAnimation' www/android-v12.js"""
if guard not in text:
    if old_guard not in text:
        raise SystemExit("Android cleanup guard insertion point not found")
    text = text.replace(old_guard, guard, 1)
